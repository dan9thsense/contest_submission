...
try:
    from ..HybridAStar.a_star import dp_planning  # , calc_obstacle_map
    from ..ReedsSheppPath import reeds_shepp_path_planning as rs
    from ..HybridAStar.car import move, check_car_collision, MAX_STEER, WB, plot_car
except:
    raise


XY_GRID_RESOLUTION = 3.0  # [m]
YAW_GRID_RESOLUTION = np.deg2rad(42.0)  # [rad]
...
def main():
    ...
    start = [10.0, 40.0, np.deg2rad(90.0)]
